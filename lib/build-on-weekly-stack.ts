...
export class BuildOnWeeklyStack extends Stack {
  constructor(scope: Construct, id: string, props?: StackProps) {
    super(scope, id, props)

    // The stream
    const stream = new kinesis.Stream(this, 'BuildOnWeeklyStream', {
      streamName: 'build-on-weekly-stream',
      shardCount: 1,
    ...
    const producer = new lambda.Function(this, 'KinesisProducer', {
      ...
      code: lambda.Code.fromAsset('lambdas/producer', { exclude: ['test'] }),
    ...
    const consumer = new lambda.Function(this, 'KinesisConsumer', {
      ...
      runtime: lambda.Runtime.NODEJS_20_X,
      code: lambda.Code.fromAsset('lambdas/consumer', { exclude: ['test'] }),
    ...
    */
    ...
    const enhancedConsumer = new kinesis.CfnStreamConsumer(this, 'EnhancedConsumer', {
      consumerName: 'build-on-weekly-stream-consumer',
   ...
   /** EFO */
    ...
    const dashboard = new cloudwatch.Dashboard(this, 'BuildOnWeeklyDashboard', {
      dashboardName: 'BuildOnWeekly'
    })
